...
<?php  include 'header.php'; ?>					
		...
		<div class="inner-banner title-area text-center image-6">
			<div class="container title-area-content">
				<h1 class="animated" data-animation="fadeInUp" data-animation-delay="200">Salades</h1>
		...
		<div class="white-bg">
			...
			<div class="menu-grid">
				<div class="container">					
					...
					<div class="row">
						<!-- Block Starts -->
					<center>Salade Ami (salade verte, tomate, carotte, maïs, concombre, poulet tandoori)... 8,90<br></center>
					<center>Salade Bombay (salade verte, tomate, carotte, concombre, olive, maïs, poisson grillées)... 9,90<br></center>
					<center>Salade Taj (salade verte, tomate, carotte, concombre, maïs, thon)... 9,90<br></center>
					<center>Salade Bollywood (salade verte, tomate, carotte, concombre, avocat, crevettes grillées).... 10,90<br></center>
