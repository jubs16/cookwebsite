...
$sql="INSERT INTO `photo_upload`(`pic`,`category_name`) VALUES('".$target_file."','".$_REQUEST['category_name']."')";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Food Photo Insert<small>View</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Food Photo</a></li>
        <li class="active">Food Photo Entry</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Food Photo Entry</h3>';	 
				 }
?>
				</div>
									...
									<label>Food Category Name</label>                 
									 <select class="form-control select2" name="category_name" onChange="showUser(this.value)" >
                                          <?php
												 ...
												 {
												    echo '<option value="'.$row['category_name'].'">'.$_REQUEST['category_name'].'</option>';
												 }
