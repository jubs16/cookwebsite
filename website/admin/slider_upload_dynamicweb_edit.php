...
if(isset($_REQUEST['submit1']))
{
  ...
  $sql="UPDATE `slider` SET `pic`='".$file_name1."', `name`='".$_REQUEST['name']."'  WHERE  id='".$_REQUEST['id']."'";
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Slider Edit</h3>';	 
				 }
?>
				</div>
        ...
        <!-- /.box-header -->
			<div class="box-body">
				<form action="" method="POST" enctype="multipart/form-data">
					<div class="row">
					  <?php
                              $update="select * from `slider` where id='".$_REQUEST['id']."'";
                              $q=$conn->query($update);
