...
if(isset($_REQUEST['submit1']))
{
 $file_name1="";
  ...
  $sql="UPDATE `service` SET `pic`='".$file_name1."', `food_type`='".$_REQUEST['food_type']."' WHERE  id='".$_REQUEST['id']."'";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Service Edit <small>View</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Service Menu</a></li>
        <li class="active">Service Menu Update</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Service Menu Update</h3>';	 
				 }
?>
				</div>
        ...
        <!-- /.box-header -->
				...
				<form action="" method="POST" enctype="multipart/form-data">
					<div class="row">
								 ...
								 <?php
                              $update="select * from `service` where id='".$_REQUEST['id']."'";
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Food Type</label>
                       				<input type="text" class="form-control" name="food_type" id="food_type" placeholder="" value="<?php echo $row2['food_type'] ;  ?>"  >
								</div>
							</div>
