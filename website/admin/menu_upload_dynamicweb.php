...
$sql="INSERT INTO `menu_upload`(`pic`,`category_name`,`price`,`food_item_name`) VALUES('".$target_file."','".$_REQUEST['category_name']."','".$_REQUEST['price']."','".$_REQUEST['food_item_name']."')";
 $result = $conn->query($sql);
 if($result)
	{
			$msg="Menu Insert Successfully";
	}
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Food Item Insert<small>View</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Food Item</a></li>
        <li class="active">Food Item Entry</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Food Item Entry</h3>';	 
				 }
?>
				</div>
					...
					<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="food_item_name" id="food_item_name" placeholder="Enter Food Item Name">
								</div>
							</div>
