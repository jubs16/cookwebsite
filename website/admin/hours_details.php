...
{
	$sql = "DELETE FROM `hours` WHERE id='" . $_REQUEST['delete'] . "'";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hours Details   <small>View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Tables</a></li>
        <li class="active">Hours Details   </li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
				{
					...
					<td>'.$row['place'].'</td>
					<td>'.$row['time'].'</td>
					<td><a href="hours_edit.php?id='.$row['id'].'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a> | 
