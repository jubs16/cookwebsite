...
if(isset($_REQUEST['submit1']))
{
 $file_name1="";
  ...
  $sql="UPDATE `photo_upload` SET `pic`='".$file_name1."',`category_name`='".$_REQUEST['category_name']."' WHERE  id='".$_REQUEST['id']."'";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Food Photo Update<small>View</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Food Photo</a></li>
        <li class="active">Food Photo Update</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Food Photo Update</h3>';	 
				 }
?>
				</div>
									 ...
									 <select class="form-control select2" name="category_name" onChange="showUser(this.value)" >
                                          <?php
													 if(isset($_REQUEST['category_name']))
												 {
                                                    ...
                                                    $sql="SELECT * FROM `photo_upload` where `id`='".$_REQUEST['id']."'";
													$q= $conn->query($sql);
