...
if(isset($_REQUEST['submit1']))
{
  ...
  $sql="UPDATE `project` SET `pic`='".$target_file."', `name`='".$_REQUEST['name']."' , `details`='".$_REQUEST['details']."' WHERE  id='".$_REQUEST['id']."'";
					...
					<div class="row">
						...
						<div class="col-md-6">
								<div class="form-group">
								 ...
								 <?php
                              $update="select * from `project` where id='".$_REQUEST['id']."'";
