...
{
	$sql = "DELETE FROM `about_us1` WHERE id='" . $_REQUEST['delete'] . "'";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        About Details   <small>View</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
				{
					...
					<td>'.$row['name'].'</td>
					<td>'.$row['details'].'</td>
					<td><a href="aboutus_edit1.php?id='.$row['id'].'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a> | 
