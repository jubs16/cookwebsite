...
if(isset($_REQUEST['submit1']))
{
 ...
 {
        $pic = basename( $_FILES["pic1"]["name"]);
    } else {
        echo "Sorry, there was an error uploading your file.";
    }	

 $sql="INSERT INTO `slider`(`pic`,`name`) VALUES('".$target_file."','".$_REQUEST['name']."')";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Slider Insert<small>Add Slider to your website</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Slider</a></li>
        <li class="active">Slider Entry</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Slider Entry</h3>';	 
				 }
?>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
								<div class="form-group">
									<label>Subject</label>                 
									<input type="text" class="form-control" name="name" id="name" placeholder="Enter About Us Subject">
								</div>
							</div>	
...
<div class="panel panel-primary">
      ...
      <div class="panel-body">
		...
		<div class="col-md-12">
				...
				<div class="form-group">
				<label>Name</label>
				<input type="text" name="name" class="form-control" value="<?php 	 if(isset($_REQUEST['name']))
												 {
												    echo $_REQUEST['name'];
												 } ?>"/>
