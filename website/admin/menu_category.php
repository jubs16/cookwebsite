...
{
  $sql="INSERT INTO `menu_category`(`category_name`) VALUES ('".$_REQUEST['name']."')";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Menu Category Entry<small>Insert</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Menu Category</a></li>
        <li class="active">Menu Category Entry</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				...
				<?php
				 ...
				 {
				    echo '<h3 class="box-title">Menu Category Entry</h3>';	 
				 }
?>
