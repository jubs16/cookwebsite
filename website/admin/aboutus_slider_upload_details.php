...
{
	$sql = "DELETE FROM `slider1` WHERE id='" . $_REQUEST['delete'] . "'";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Slider Details   <small>View</small>
      </h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				...
				while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
				{
					...
					<td><a href="aboutus_slider_edit.php?id='.$row['id'].'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a> | 
