...
{
  $sql="INSERT INTO `schoolcategory`( `school`, `category`) VALUES ('".$_REQUEST['school']."','".$_REQUEST['name']."')";
  $res=mysql_query($sql);
  if($res)
	{
			$msg="School Category Insert Successfully";
	}
}
?>
		...
		<div class="box box-default">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">School Entry</h3>';	 
				 }
?>
				</div>
