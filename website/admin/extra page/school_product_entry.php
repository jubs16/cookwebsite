...
$file1_name="";
  ...
  $sql="INSERT INTO `picture`( `album_name`, `pic_name`, `desc`, `price`,`pic`) VALUES  ('".$_REQUEST['alb_nm']."','".$_REQUEST['name']."','".$_REQUEST['details']."','".$_REQUEST['price']."','".$file1_name."')";
  $res=mysql_query($sql);
  if($res)
	{
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Details</label>                 
									<textarea class="form-control" name="details" id="1" placeholder="Enter Details "></textarea>
                        ...
                        <div class="col-md-12">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name" id="1" placeholder="Enter Product Name">
								</div>
							</div>	
