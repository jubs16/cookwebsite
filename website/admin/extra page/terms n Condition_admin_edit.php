...
{
  $sql="UPDATE `tc` SET `heading`='".$_REQUEST['heading']."',`description`='".$_REQUEST['description']."' WHERE  id='".$_REQUEST['id']."'";
  $res=mysql_query($sql);
  if($res)
	{
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Terms & Condition <small>Update</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">T&C</a></li>
        <li class="active">T&C Update</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				...
				<?php
				 ...
				 {
				    echo '<h3 class="box-title">T&C Update</h3>';	 
				 }
?>
        ...
        <!-- /.box-header -->
			<div class="box-body">
				...
				<?php
                              $update="select * from `tc` where id='".$_REQUEST['id']."'";
