...
{
	$sql = "DELETE FROM `office` WHERE id='" . $_REQUEST['delete'] . "'";
	$res = mysql_query($sql);
}
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        office Details   <small>View</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				while ($row = mysql_fetch_array($result))
				{
					...
					<td>'.$sl.'</td>
					<td>'.$row['name'].'</td>
					<td><a href="office_edit.php?id='.$row['id'].'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a> | 
