...
$file1_name="";
  ...
  else
  {
   ...
   $sql="UPDATE `picture` SET `album_name`='".$_REQUEST['alb_nm']."',`pic_name`='".$_REQUEST['name']."',`desc`='".$_REQUEST['details']."',`price`='".$_REQUEST['price']."',`pic`='".$file1_name."' WHERE  id='".$_REQUEST['id']."'";
					...
					<div class="row">
						...
						<div class="col-md-6">
								<div class="form-group">
									<label>Album Name</label>                 
									 <select class="form-control select2" name="alb_nm" onChange="showUser(this.value)" >
                                                  <?php
													echo '<option value="'.$row1['album_name'].'">'.$row1['album_name'].'</option>';
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Details</label>                 
									<textarea class="form-control" name="details" id="1" placeholder="Enter Category Name"><?php echo $row1['desc'] ;  ?></textarea>
                        ...
                        <div class="col-md-12">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name" id="1" placeholder="Enter Category Name" value="<?php echo $row1['pic_name'] ;  ?>" >
								</div>
							</div>	
	    ...
	    <div class="col-md-12">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="hidden" class="form-control" name="pic1" id="pic1" placeholder="" value="<?php echo $row1['pic'] ?>">
									</div>	
								</div>
