...
$sql="INSERT INTO `product1`(`pic`, `name`, `price`,`details`) VALUES('".$target_file."','".$_REQUEST['name']."','".$_REQUEST['price']."','".$_REQUEST['details']."')";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Home Menu Insert   <small>View</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Home Menu</a></li>
        <li class="active">Home Menu Entry</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Home Menu Entry</h3>';	 
				 }
?>
				</div>
