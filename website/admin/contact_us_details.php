...
{
	$sql = "DELETE FROM `contact_us` WHERE id='" . $_REQUEST['delete'] . "'";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Contact Us Details   <small>View</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
				{
					...
					<td>'.$row['phone'].'</td>
					<td>'.$row['email'].'</td>
					<td><a href="contact_us_edit.php?id='.$row['id'].'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a> | 
