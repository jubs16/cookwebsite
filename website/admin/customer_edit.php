...
if(isset($_REQUEST['submit1']))
{
  ...
  $sql="UPDATE `customer` SET `pic`='".$target_file."', `name`='".$_REQUEST['name']."' , `details`='".$_REQUEST['details']."' WHERE  id='".$_REQUEST['id']."'";
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Testimonials Update<small>Review</small>
     
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Testimonials</a></li>
        <li class="active">Testimonials Entry</li>
      </ol>
    </section>
		...
		<div class="box box-primary">
			<div class="box-header with-border"> 
				<div class="box-header">
				 ...
				 {
				    echo '<h3 class="box-title">Testimonials Update</h3>';	 
				 }
?>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
								<div class="form-group">
								 ...
								 <?php
                              $update="select * from `customer` where id='".$_REQUEST['id']."'";
