...
<?php  include 'header.php'; ?>					
		...
		<div class="inner-banner title-area text-center image-6">
			<div class="container title-area-content">
				<h1 class="animated" data-animation="fadeInUp" data-animation-delay="200">Curry Indien</h1>
		...
		<div class="menu-grid">
				<div class="container">					
					...
					<div class="row">
						...
						<!-- Block Ends -->
						<!-- Block Starts -->
										<center>Spécialité du sud de l’Inde. Epices raffinées aromatisées avec ail, cardamome, tomate et oign<br></center>
					<center>Poulet curry... 9,90<br></center>
					<center>Boeuf curry... 10,90<br></center>
					<center>Poisson curry... 10,90<br></center>
					<center>Agneau curry... 10,90<br></center>
					<center>Crevette curry... 10,90<br></center>
					<center>Poulet dall dadocka (sauce curry avec lentilles indien)... 10,90<br></center>
					<center>Boeuf dall dadocka (sauce curry avec lentilles indien)... 10,90<br></center>
					<center>Agneau dall dadocka (sauce curry avec lentilles indien)... 10,90<br></center>
