...
<?php  include 'header.php'; ?>					
		...
		<div class="inner-banner title-area text-center image-6">
			<div class="container title-area-content">
				<h1 class="animated" data-animation="fadeInUp" data-animation-delay="200">Pain Indien</h1>
			...
			<div class="menu-grid light-grey-bg">
				<div class="container">					
					...
					<div class="row">
						...
						<!-- Block Ends -->
						<!-- Block Starts -->
					<center>Nan nature... 2,00<br></center>
					<center>Nan fromage... 3,00<br></center>
					<center>Nan à l'ail... 3,00<br></center>
					<center>Nan keema (nan viande hachée) 4,000<br></center>
					<center>Chapati... 2,0<br></center>
