...
<?php  include 'header.php'; ?>					
		...
		<div class="inner-banner title-area text-center image-6">
			<div class="container title-area-content">
				<h1 class="animated" data-animation="fadeInUp" data-animation-delay="200">Desserts maison</h1>
		...
		<div class="menu-grid">
				<div class="container">					
					...
					<div class="row">
						...
						<!-- Block Ends -->
						<!-- Block Starts -->
					<center>Kesari (Gâteu de semoule indien)... 3,20<br></center>

<center>Fromage blanc... 3,90<br></center>

<center>Gulfi (Glace indien : pistache ou mangue)... 4,50<br></center>

<center>Kaju katli...4,50<br></center>

<center>Salade de fruits frais... 4,50<br></center>

<center>Glaces ou Sorbets (3 boules au choix : vanille, chocolat, mangue, citron vert)... 4,00<br></center>
