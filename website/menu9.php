...
<?php  include 'header.php'; ?>					
		...
		<div class="inner-banner title-area text-center image-6">
			<div class="container title-area-content">
				<h1 class="animated" data-animation="fadeInUp" data-animation-delay="200">Végétarien</h1>
		...
		<div class="menu-grid light-grey-bg">
				<div class="container">					
					...
					<div class="row">
						...
						<!-- Block Ends -->
						<!-- Block Starts -->
					<center>Biriyani légumes... 8,90<br></center>

					<center>Curry d'aubergine... 8,90<br></center>

					<center>Lentille d'indien... 9,90<br></center>

					<center>Palak Paner (épinard et fromage)... 9,90<br></center>

					<center>Légume kourma (légumes mixte)... 9,90<br></center>

					<center>Vindaloo au pomme de terre... 9,90<br></center>

					<center>Champignon kourma...9,90<br></center>
						<!-- Block Ends -->
						<!-- Block Starts -->
